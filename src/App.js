    ...
    return (
      <div className="nav-scroller py-1 mb-2">
        <nav className="nav d-flex justify-content-between">
          <NavLink  exact to="/" className="p-2 text-muted">General</NavLink>
          <NavLink to="/" className="p-2 text-muted">Business</NavLink>
          <NavLink to="/" className="p-2 text-muted">Science</NavLink>
          <NavLink to="/" className="p-2 text-muted">Health</NavLink>
...
export class NavSwitch extends Component {
  render () {
    return (
      <Switch>
        <Route exact path="/" render={(props) => <NewsArticle {...props} articles={this.props.articles}/>}/>
